...
{% comment %}
===================================================================
RECENT SITE UPDATES - REDESIGNED
===================================================================
{% endcomment %}

<div class="alert alert-info" role="alert">
  <h4 class="alert-heading">Automated Commit Log</h4>
  <p>Track the latest raw changes to this site and my other projects.</p>
  <hr>
  <ul class="mb-0">
    <li><a href="/updates" class="alert-link">All Commits</a></li>
  </ul>
</div>
