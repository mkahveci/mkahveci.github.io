...
<script>
    document.addEventListener("DOMContentLoaded", () => {
      ...
      // (Copied from our previous work to match your site's style)
      ...
      // --- 3. POPULATE DROPDOWN ---
      // This function builds the <option> list for the dropdown
      ...
      // This function builds the commit cards and injects them
            ...
            <div class="card shadow-sm h-100 border-0 d-flex flex-column">
                <div class="card-body d-flex flex-grow-1">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1">
                            <a href="${c.url}" target="_blank" rel="noopener noreferrer" class="text-decoration-none">${c.message}</a>
                        </h6>
      ...
      // --- 5. EVENT LISTENER ---
      // When the dropdown value changes, re-render the commit list
