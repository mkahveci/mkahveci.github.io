            ...
            <div class="col">
                <div class="card shadow-sm h-100 border-0">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h5 class="card-title fw-bold text-body">Portfolio Allocation (The 70/10/20 Blend)</h5>
            ...
            <div class="col">
                <div class="card shadow-sm h-100 border-0">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h5 class="card-title fw-bold text-body">High-Frequency, Quick-Capture Trading</h5>
            ...
            <div class="col">
                <div class="card shadow-sm h-100 border-0">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h5 class="card-title fw-bold text-body">Futures Product Selection</h5>
            ...
            <div class="col">
                <div class="card shadow-sm h-100 border-0">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h5 class="card-title fw-bold text-body">Futures as a Hedging Tool</h5>
...
A["fa:fa-search Monitor Short Strangle"]:::c-start
...
E & G --> H["fa:fa-tasks Position is Hedged. Manage Trade."]:::c-end
' caption='1. The decision-making workflow for using /MES futures to hedge a short strangle against sharp directional moves.' %}
            ...
            <div class="col">
                <div class="card shadow-sm h-100 border-0">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h5 class="card-title fw-bold text-body">The Golden Rule: 1 Standard Deviation (\(\text{1SD}\))</h5>
            ...
            <div class="col">
                <div class="card shadow-sm h-100 border-0">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h5 class="card-title fw-bold text-body">Risk-Defined Trading</h5>
